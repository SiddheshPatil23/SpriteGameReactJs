...
if (true) {
  /* unused reexport */ __webpack_require__(989);
} else {}
...
var react_is = __webpack_require__(737);
...
const hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect = typeof window !== 'undefined' ? react.useLayoutEffect : react.useEffect;
 ...
 */ function useCollector(monitor, collect, onUpdate) {
    ...
    hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(updateCollected);
    return [
        collected,
        updateCollected
    ];
...
function useMonitorOutput(monitor, collect, onCollect) {
    ...
    hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function subscribeToMonitorStateChange() {
...
function dist_shallowEqual(objA, objB, compare, compareContext) {
...
class SourceConnector {
    ...
    didDragSourceOptionsChange() {
        return !dist_shallowEqual(this.lastConnectedDragSourceOptions, this.dragSourceOptions);
    }
    didDragPreviewOptionsChange() {
        return !dist_shallowEqual(this.lastConnectedDragPreviewOptions, this.dragPreviewOptions);
    }
...
function useDragSourceConnector(dragSourceOptions, dragPreviewOptions) {
    ...
    hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(()=>{
...
function useRegisteredDragSource(spec, monitor, connector) {
    ...
    hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function registerDragSource() {
        if (itemType != null) {
...
function Sidebar() {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "font-bold"
  }, " ", "Events", " "), sprites.map(sprite => /*#__PURE__*/react.createElement(DraggableAction, {
    key: sprite.id,
    type: "event",
    spriteId: sprite.id
  }, `When clicked on Sprite ${sprite.id}`)), /*#__PURE__*/react.createElement("div", {
    className: "font-bold"
  }, " ", "Motion", " "), /*#__PURE__*/react.createElement(DraggableAction, {
    type: "move",
  ...
  }, "Move 10 steps")), /*#__PURE__*/react.createElement(DraggableAction, {
    type: "turnLeft",
    spriteId: selectedSpriteId,
  ...
  }), "15 degrees")), /*#__PURE__*/react.createElement(DraggableAction, {
    type: "turnRight",
    spriteId: selectedSpriteId,
...
function PreviewArea() {
  ...
  }, sprites.map(sprite => /*#__PURE__*/react.createElement(CatSprite, {
    key: sprite.id,
...
class TargetConnector {
    ...
    didOptionsChange() {
        return !dist_shallowEqual(this.lastConnectedDropTargetOptions, this.dropTargetOptions);
    }
...
function useRegisteredDropTarget(spec, monitor, connector) {
    ...
    hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function registerDropTarget() {
...
function MidArea() {
  ...
  const selectedSpriteId = useSelector(state => state.sprites.selectedSpriteId);
  const sprites = useSelector(state => state.sprites.sprites);
  const [actionQueue, setActionQueue] = (0,react.useState)([]);
  const spritesRef = (0,react.useRef)(sprites);
  (0,react.useEffect)(() => {
  ...
  const [{
    ...
    drop: item => {
      ...
      setActionQueue(prevQueue => [...prevQueue, {
        type: item.type
      }]);
    },
    collect: monitor => ({
  ...
  }, /*#__PURE__*/react.createElement("div", null, "Mid Area - Drop actions here"), /*#__PURE__*/react.createElement("button", {
    onClick: executeActions,
    className: "mt-2 p-2 bg-blue-500 text-white",
    disabled: actionQueue.length === 0
  }, "Play Actions"), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("h3", null, "Queued Actions:"), /*#__PURE__*/react.createElement("ul", null, actionQueue.map((action, index) => /*#__PURE__*/react.createElement("li", {
    key: index
  }, `${action.type} on Selected Sprite ID: ${selectedSpriteId}`)))));
}
...
function Game() {
  ...
  }, "Add Sprite"), /*#__PURE__*/react.createElement("div", {
...
function _objectWithoutProperties(source, excluded) {
    ...
    var target = DndProvider_objectWithoutPropertiesLoose(source, excluded);
    var key, i;
    if (Object.getOwnPropertySymbols) {
...
function DndProvider_objectWithoutPropertiesLoose(source, excluded) {
    if (source == null) return {};
    var target = {};
...
root.render(/*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(components_Provider, {
  store: src_store
